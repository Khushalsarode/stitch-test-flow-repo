...
/** v1.2 — fails in GitHub Actions on purpose; JWT_SECRET is omitted from the workflow env. */
test("CI must provide JWT_SECRET for auth", () => {
  assert.ok(process.env.JWT_SECRET, "JWT_SECRET must be set in CI (add to .github/workflows/ci.yml)");
});
